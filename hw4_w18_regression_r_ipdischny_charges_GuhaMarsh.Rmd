...
```{r}
# Model Building to Understand the effect of the Predictors on the Response Variable 
...
```{r}
# Model Building to Understand the effect of the Predictors on the Response Variable, by removing APR_DRG_Desc for viewing the Correlation Matrix 
...
# Selecting Just the Numeric to Build the Correlation Matrix
...
```{r}
# Model Coefficients
TotalCharges3$coefficients
```

```{r}
# Coefficient Plot
coefplot(TotalCharges3)
```
