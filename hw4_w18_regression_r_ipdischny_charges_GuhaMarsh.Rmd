...
=======
library(boot)
>>>>>>> 9ae1915f379646bb32f683e377a0bde526f16aa4
```
...
# Top 1 Predictive Model, Test MAD: 5771.55
```{r}
...
# Top 2 Predictive Model, Test MAD: 5839.624
```{r}
...
# Top 3 Predictive Model, Test MAD: 5922.874
```{r}
...
1. Model 13, Train MAD: 5745.559, Test MAD: 5777.55
2. Model 10, Train MAD: 5887.513, Test MAD: 5839.624
3. Model 9, Train MAD: 5932.954, Test MAD: 5922.874

So, clearly our Model 10 & Model 9 has the lower MAD for the test data. And Model 10 has the lowest MAD for the test data.
...
```{r}
# multiplot(totalCharges13$madA13, totalChargesPredict13$madP13)

#, madA9, madP9, madA10, madP10)
```
