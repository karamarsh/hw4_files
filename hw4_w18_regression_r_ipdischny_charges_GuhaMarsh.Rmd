...
## Other Predictive Models & their Respective MAD
Since Top 3 Models are already evaluated above hence they are excluded from this analysis.

# Predictive Model 1, MAD: 7630.359
```{r}
# Predictive Model, based on Model 1 of Train Data
totalChargesPredictLM1 <- lm(Total_Charges ~ Total_Costs + Age_Group + Gender + Health_Service_Area + Race + Ethnicity + Length_of_Stay + Type_of_Admission + Patient_Disposition + Payment_Typology_1 + APR_Risk_of_Mortality + APR_Severity_of_Illness_Desc + APR_DRG_Desc, data = ipd_test)

summary(totalChargesPredictLM1)

# Compute the MAD value
median(abs(totalChargesPredictLM1$residuals))
```

# Predictive Model 2, MAD: 7630.538
```{r}
# Predictive Model, based on Model 2 of Train Data
totalChargesPredictLM2 <- lm(Total_Charges ~ Total_Costs + Age_Group + Health_Service_Area + Race + Ethnicity + Length_of_Stay + Type_of_Admission + Patient_Disposition + Payment_Typology_1 + APR_Risk_of_Mortality + APR_Severity_of_Illness_Desc + APR_DRG_Desc, data = ipd_test)


summary(totalChargesPredictLM2)

# Compute the MAD value
median(abs(totalChargesPredictLM2$residuals))
```

# Predictive Model 3, MAD: 7627.171
```{r}
# Predictive Model, based on Model 3 of Train Data
totalChargesPredictLM3 <- lm(Total_Charges ~ Total_Costs + Age_Group + Health_Service_Area + Race + Ethnicity + Length_of_Stay + Type_of_Admission + Payment_Typology_1 + APR_Risk_of_Mortality + APR_Severity_of_Illness_Desc + APR_DRG_Desc, data = ipd_test)

summary(totalChargesPredictLM3)

# Compute the MAD value
median(abs(totalChargesPredictLM3$residuals))
```

# Predictive Model 4, MAD: 7705.694
```{r}
# Predictive Model, based on Model 4 of Train Data
totalChargesPredictLM4 <- lm(Total_Charges ~ Total_Costs + Age_Group + Health_Service_Area + Race + Ethnicity + Length_of_Stay + Type_of_Admission + Payment_Typology_1 + APR_Risk_of_Mortality + APR_Severity_of_Illness_Desc, data = ipd_test)

summary(totalChargesPredictLM4)

# Compute the MAD value
median(abs(totalChargesPredictLM4$residuals))
```

# Predictive Model 5, MAD: 7640.95
```{r}
# Predictive Model, based on Model 5 of Train Data
totalChargesPredictLM5 <- lm(Total_Charges ~ Total_Costs + Length_of_Stay + Health_Service_Area + Type_of_Admission + Payment_Typology_1 + Age_Group, data = ipd_test)

summary(totalChargesPredictLM5)

# Compute the MAD value
median(abs(totalChargesPredictLM5$residuals))

# Model Visualization
coefplot(totalChargesPredictLM5)

# Model Visualization Considering Removing Some Insignificant Predictors
coefplot(totalChargesPredictLM5,predictors=c("Length_of_Stay","Total_Costs", "Health_Service_Area", "Type_of_Admission", "Payment_Typology_1"))
```


## Additive Predictive Models
# Predictive Model 6, MAD: 7618.097
```{r}
# Predictive Model, based on Model 6 of Train Data
totalChargesPredictLM6 <- lm(Total_Charges ~ Total_Costs  + Age_Group + Health_Service_Area + Length_of_Stay * Payment_Typology_1 + Type_of_Admission + APR_Risk_of_Mortality + APR_Severity_of_Illness_Desc, data = ipd_test)

summary(totalChargesPredictLM6)

# Compute the MAD value
median(abs(totalChargesPredictLM6$residuals))
```

# Predictive Model 7, MAD: 7486.655
```{r}
# Predictive Model, based on Model 7 of Train Data
totalChargesPredictLM7 <- lm(Total_Charges ~ Age_Group + Health_Service_Area + Length_of_Stay * Payment_Typology_1 * Total_Costs +  Type_of_Admission + APR_Risk_of_Mortality + APR_Severity_of_Illness_Desc, data = ipd_test)

summary(totalChargesPredictLM7)

# Compute the MAD value
median(abs(totalChargesPredictLM7$residuals))
```

# Predictive Model 8, MAD: 7501.213
```{r}
# Predictive Model, based on Model 8 of Train Data
totalChargesPredictLM8 <- lm(Total_Charges ~ Age_Group + Health_Service_Area + Length_of_Stay * Payment_Typology_1 * Total_Costs + Type_of_Admission * APR_Severity_of_Illness_Desc + APR_Risk_of_Mortality, data = ipd_test)

summary(totalChargesPredictLM8)

# Compute the MAD value
median(abs(totalChargesPredictLM8$residuals))
```

# Predictive Model 11, MAD: 6366.077
```{r}
# Predictive Model, based on Model 11 of Train Data
totalChargesPredictLM11 <- lm(Total_Charges ~ Total_Costs + Length_of_Stay * Health_Service_Area + Payment_Typology_1 + Age_Group + Type_of_Admission + APR_Severity_of_Illness_Desc + APR_Risk_of_Mortality, data = ipd_test)

summary(totalChargesPredictLM11)

# Compute the MAD value
median(abs(totalChargesPredictLM11$residuals))

# Model Visualization
coefplot(totalChargesPredictLM11)

# Model Visualization Considering only the Numeric Predictors
coefplot(totalChargesPredictLM11,predictors=c("Length_of_Stay","Total_Costs"))
```

# Predictive Model 12, MAD: 6358.837
```{r}
# Predictive Model, based on Model 12 of Train Data
totalChargesPredictLM12 <- lm(Total_Charges ~ Total_Costs + Length_of_Stay * Health_Service_Area + Payment_Typology_1 + Age_Group + Type_of_Admission + APR_Severity_of_Illness_Desc, data = ipd_test)

summary(totalChargesPredictLM12)

# Compute the MAD value
median(abs(totalChargesPredictLM12$residuals))
```
