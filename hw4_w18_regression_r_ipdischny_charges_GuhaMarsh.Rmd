...
ggplot(data = ipd_train) + geom_point(aes(x = Total_Charges, y = Total_Costs))

ggplot(data = ipd_train) + geom_point(aes(x = Total_Charges, y = Total_Costs)) + 
  facet_wrap(~Payment_Typology_1)

ggplot(data = ipd_train) + geom_histogram(aes(x = Total_Charges, fill = APR_Severity_of_Illness_Desc))
